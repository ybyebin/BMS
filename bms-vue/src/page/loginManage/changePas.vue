    ...
    <div class="box base-show">
      <section class="main ">
        ...
        <Form ref="formInline" :model="formInline" :rules="ruleInline">
          ...
          <Form-item prop="oldPassword" @keydown.enter.native="handleSubmit('formInline')">
            <Input type="password" v-model="formInline.oldPassword" placeholder="旧密码">
              <Icon type="ios-lock" slot="prepend"/>
            </Input>
          </Form-item>
           <Form-item prop="newPassword" @keydown.enter.native="handleSubmit('formInline')">
            <Input type="password" v-model="formInline.newPassword" placeholder="新密码">
              <Icon type="ios-lock" slot="prepend"/>
            </Input>
          </Form-item>
          <Form-item>
            <Button type="primary" @click="handleSubmit('formInline')" :loading="loading" long>确认修改</Button>
          </Form-item>
        </Form>
      </section>
    </div>
